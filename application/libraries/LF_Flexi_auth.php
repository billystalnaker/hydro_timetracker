...
class LF_Flexi_auth extends LF_Flexi_auth_lite{
    ...
    public function get_user_group_privileges_array($sql_select = FALSE, $sql_where = FALSE){
        return $this->CI->flexi_auth_model->get_user_group_privileges($sql_select, $sql_where)->result_array();
    }
