 ...
 */
$config['security']['static_salt'] = 'V6Dy89Jjspa5qy';
 ...
 */
$config['security']['database_salt_length'] = strlen($config['security']['static_salt']);
 ...
 * @param: int
 */
$config['settings']['admin_group'] = 4;

/**
 * Don't pull thisuser for users who are not admin.
 * @param: int
 */
$config['settings']['admin_user']		 = 12;
/**
